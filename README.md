...
## 사용법:
usage: smi2srt [-h] [-r] [-d] [-i] [-m] dir

positional arguments:
  dir                   target directory. ex) ./smi2srt <OPTIONS> ./Movies

optional arguments:
  -h, --help            show this help message and exit
  -r, --replace_file    replace srt file when srt file already exists 
  -d, --delete_original
                        remove original smi file when converting succeed
  -i, --ignore          ignore decoding error
  -m, --multi-subs      convert multiple subtitles
